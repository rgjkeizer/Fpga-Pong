# qsys scripting (.tcl) file for DE10_NANO_QSYS
package require -exact qsys 16.0

create_system {DE10_NANO_QSYS}
...
add_connection clk_50.clk_reset adc_ltc2308.reset_sink

add_connection clk_50.clk_reset jtag_uart.reset

add_connection clk_50.clk_reset nios2_qsys.reset
...
add_connection nios2_qsys.data_master adc_ltc2308.slave
...
add_connection nios2_qsys.data_master onchip_memory2.s1
...
add_connection nios2_qsys.data_master sw.s1
...
add_connection nios2_qsys.data_master sysid_qsys.control_slave
...
add_connection nios2_qsys.debug_reset_request nios2_qsys.reset
...
add_connection nios2_qsys.instruction_master onchip_memory2.s1
...
add_connection nios2_qsys.irq sw.irq
set_connection_parameter_value nios2_qsys.irq/sw.irq irqNumber {1}

add_connection pll_sys.outclk0 adc_ltc2308.clock_sink

add_connection pll_sys.outclk0 jtag_uart.clk

add_connection pll_sys.outclk0 nios2_qsys.clk

add_connection pll_sys.outclk0 onchip_memory2.clk1

add_connection pll_sys.outclk0 sw.clk

add_connection pll_sys.outclk0 sysid_qsys.clk

add_connection pll_sys.outclk1 adc_ltc2308.clock_sink_adc

# interconnect requirements
set_interconnect_requirement {$system} {qsys_mm.clockCrossingAdapter} {HANDSHAKE}
set_interconnect_requirement {$system} {qsys_mm.maxAdditionalLatency} {1}

save_system {DE10_NANO_QSYS.qsys}
